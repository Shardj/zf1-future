...
require_once 'Zend/Cache/Backend/Apcu.php';
 ...
 * @group      Zend_Cache
 */
class Zend_Cache_ApcuBackendTest extends Zend_Cache_CommonExtendedBackendTest {

    protected $_instance;

    public function __construct($name = null, array $data = [], $dataName = '')
    {
        parent::__construct('Zend_Cache_Backend_Apcu', $data, $dataName);
    }

    public function setUp($notag = true)
    {
        $this->_instance = new Zend_Cache_Backend_Apcu([]);
        parent::setUp($notag);
    }
    ...
    {
        $test = new Zend_Cache_Backend_Apcu();
    }
