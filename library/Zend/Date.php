        ...
        switch ($part) {
            ...
            case self::DAY:
                if (is_numeric($date)) {
                    return $this->_assign(
                        $calc,
                        $this->mktime(0, 0, 0, 1, 1 + (int)$date, 1970, true),
                        $this->mktime(0, 0, 0, 1, 1 + (int)$day, 1970, true),
                        $hour
                    );
                }
            ...
            case self::YEAR_8601:
                if (is_numeric($date)) {
                    ...
                    return $this->_assign(
                        $calc,
                        $this->mktime(0, 0, 0, $month, $day, (int)$date, true),
                        $this->mktime(0, 0, 0, $month, $day, $year, true),
                        false
                    );
                }
            ...
            case self::HOUR_SHORT_AM:
                if (is_numeric($date)) {
                    return $this->_assign(
                        $calc,
                        $this->mktime((int)$date, 0, 0, 1, 1, 1970, true),
            ...
            case self::MINUTE:
                if (is_numeric($date)) {
                    return $this->_assign(
                        $calc,
                        $this->mktime(0, (int)$date, 0, 1, 1, 1970, true),
            ...
            case self::SECOND:
                if (is_numeric($date)) {
                    return $this->_assign(
                        $calc,
                        $this->mktime(0, 0, (int)$date, 1, 1, 1970, true),
