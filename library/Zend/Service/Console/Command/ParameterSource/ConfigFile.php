    ...
    public function getValueForParameter($parameter, $argv = [])
    {
        ...
        foreach ($parameter->aliases as $alias) {
            if (array_key_exists($alias, $iniValues)) {
                ...
                break;
            } elseif (array_key_exists(strtolower($alias), $iniValues)) {
                $parameterValue = $iniValues[strtolower($alias)];
                break;
            } elseif (array_key_exists(str_replace('-', '', $alias), $iniValues)) {
                $parameterValue = $iniValues[str_replace('-', '', $alias)];
                break;
            } elseif (array_key_exists(strtolower(str_replace('-', '', $alias)), $iniValues)) {
